...
function show_list () {
	...
	for (let i = manhua_num; i <= manhua_max_num; i++) {
		...
		title_a.setAttribute ("href", "changpian_wanjie_manhua_index.html?list_num=" + manhua_list[i][1] + "&name=" + manhua_list[i][0]);
		...
		entry_p_a.setAttribute ("href", "changpian_wanjie_manhua_index.html?list_num=" + manhua_list[i][1] + "&name=" + manhua_list[i][0]);
		...
		entry_p_a_img.setAttribute ("src", "https://raw.githubusercontent.com/n454149301/web_database_changpian_wanjie_manhua" + manhua_list[i][1] + "/master/manhua/" + manhua_list[i][0] + "/0001/001.jpg");
...
function get_list (num) {
	...
	xhr.open ("GET", "../web_database_changpian_wanjie_manhua/" + num + "/list.txt");
